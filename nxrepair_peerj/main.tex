...
Based on the resultant ROC plots, shown in Figure~\ref{fig:ROCs}, a threshold in $Z$ of -4 was found to optimise the true positive: false positive ratio. This threshold was used for all subsequent analyses. 
